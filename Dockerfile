...
# 8. Copy the network volume path mapping into ComfyUI
COPY extra_model_paths.yaml /workspace/ComfyUI/extra_model_paths.yaml

# 9. Start the RunPod Serverless worker
COPY handler.py .
CMD ["python", "-u", "handler.py"]FROM pytorch/pytorch:2.5.0-cuda12.4-cudnn9-runtime
